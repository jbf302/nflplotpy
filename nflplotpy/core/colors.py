...
class NFLColorPalette:
    ...
    def get_team_colors(
        self, teams: str | list[str], color_type: str = "primary"
    ) -> str | list[str]:
        ...
        if color_type not in ["primary", "secondary", "tertiary", "quaternary"]:
            msg = f"Invalid color_type: {color_type}"
    ...
    def create_team_palette(
        self, teams: list[str], color_type: str = "primary"
    ) -> list[str]:
    ...
    def create_gradient(
        self, team1: str, team2: str, n_colors: int = 10, color_type: str = "primary"
    ) -> list[str]:
    ...
    def to_matplotlib_colormap(
        self, teams: list[str], color_type: str = "primary", name: str = "nfl_teams"
...
_palette_manager: NFLColorPalette | None = None
...
def get_team_colors(
    teams: str | list[str], color_type: str = "primary"
) -> str | list[str]:
    """Get colors for specified teams.
